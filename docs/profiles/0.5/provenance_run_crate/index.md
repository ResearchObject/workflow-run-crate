...
* Version: 0.5
* Permalink: <https://w3id.org/ro/wfrun/provenance/0.5>
...
<table>
  ...
  <tr>
   <td>conformsTo</td>
   <td>MUST</td>
   <td>Array MUST reference a <code>CreativeWork</code> entity with an <code>@id</code> URI that is consistent with the versioned <em>Permalink</em> of this document, and SHOULD also reference versioned permalinks for <a href="https://w3id.org/ro/wfrun/process/0.5">Process Run Crate</a>, <a href="https://w3id.org/ro/wfrun/workflow/0.5">Workflow Run Crate</a> and <a href="https://w3id.org/workflowhub/workflow-ro-crate/1.0">Workflow RO-Crate</a>.</td>
  </tr>
